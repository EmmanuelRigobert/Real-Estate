            ...
            <?php
                //include banner.php
                include('sectionsPHP/banner.php');
            
                //include how to use (htu.php)
                include('sectionsPHP/htu.php');

                //include singleProperties.php
                include('sectionsPHP/singleProperties.php');

                //include locations.php
                include('sectionsPHP/locations.php');

                //include testimonials.php
                include('sectionsPHP/testimonials.php');

                //include call.php
                include('sectionsPHP/call.php');
            ?>
